			...
			<div class="row justify-content-center">
				<div class="col-sm-4">
					<form action="index.php" method="post">
						<div class="mb-3">
							<input type="text" name="text_nome" class="form-control" placeholder="Nome" value="<?php echo empty($nome) ? $nome : ''; ?>">
							<?php if (!empty($error_nome)) { ?>
								<p class="text-danger"><?php echo $error_nome; ?></p>
							<?php } ?>
						</div>
						<div class="mb-3">
							<input type="text" name="text_apelido" class="form-control" placeholder="Apelido" value="<?php echo empty($apelido) ? $apelido : ''; ?>">
