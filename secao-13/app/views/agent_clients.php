<div class="container-fluid">
    <div class="row justify-content-center">
        ...
        <div class="col-12 p-5 bg-white">
            ...
            <div class="row">
                <div class="col">
                    <h5><i class="fa-solid fa-user-tie me-2"></i>Agente: <strong><?php echo $user->name; ?></strong></h5>
                </div>
                    ...
                    <tbody>
                        <?php foreach ($clients as $client) { ?>
                            <tr>
                                ...
                                <td class="text-end">
                                    <a href="?ct=agent&mt=edit_client&id=<?php echo aes_encrypt($client->id); ?>"><i class="fa-regular fa-pen-to-square me-2"></i>Editar</a>
                                    <span class="mx-2 opacity-50">|</span>
                                    <a href="?ct=agent&mt=delete_client&id=<?php echo aes_encrypt($client->id); ?>"><i class="fa-solid fa-trash-can me-2"></i>Eliminar</a>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
